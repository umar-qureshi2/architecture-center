...
- [Migrate Virtual Machines to Azure (video)](https://azure.microsoft.com/resources/videos/asrhowto-video2-migrate-virtual-machines-to-azure/)

- [Azure Site Recovery: About migration](/azure/site-recovery/site-recovery-migrate-to-azure)

- [Azure Site Recovery support matrix for replicating from on-premises to Azure](/azure/site-recovery/site-recovery-support-matrix-to-azure)
...
**Is the data intended to be archived or is it live data?**
...
[https://azure.microsoft.com/en-us/resources/videos/asrhowto-video2-migrate-virtual-machines-to-azure/](
